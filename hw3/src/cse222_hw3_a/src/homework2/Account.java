...
public class Account {
     ...
     */
    protected ArrayList<Account> following = new ArrayList<>();


    /**
     * An array of accounts that are following this account (which are this account's "followers").
     */
    protected ArrayList<Account> followers = new ArrayList<>();
     ...
     */
    protected ArrayList<Message> outbox = new ArrayList<>();

    /**
     * An ArrayList of strings which stores the user's action history.
     */
    protected ArrayList<String> actionHistory = new ArrayList<>();
    /**
     * An ArrayList of Account objects who are blocked by the current user.
     */
    protected ArrayList<Account> blockedUsers = new ArrayList<>();
    ...
    protected void isLoggedInCheck(){
        if(isLoggedIn == false){
            throw new IllegalStateException("Please Log-In to the account first. The account you are trying to operate is not logged in.");
