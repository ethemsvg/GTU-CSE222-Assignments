...
public class Account {
    ...
    /**
     * An LDLinkedList of accounts that this account is following.
     */
    protected LDLinkedList<Account> following = new LDLinkedList<>();


    /**
     * An LDLinkedList of accounts that are following this account (which are this account's "followers").
     */
    protected LDLinkedList<Account> followers = new LDLinkedList<>();

    /**
     * An LDLinkedList of posts that have been made by this account.
     */
    protected LDLinkedList<Post> posts = new LDLinkedList<>();

    /**
     * An LDLinkedList of messages that have been 'received' by this account.
     */
    protected LDLinkedList<Message> inbox = new LDLinkedList<>();

    /**
     * An LDLinkedList of messages that have been 'sent' by this account.
     */
    protected LDLinkedList<Message> outbox = new LDLinkedList<>();

    /**
     * An LDLinkedList of strings which stores the user's action history.
     */
    protected LDLinkedList<String> actionHistory = new LDLinkedList<>();
    /**
     * An LDLinkedList of Account objects who are blocked by the current user.
     */
    protected LDLinkedList<Account> blockedUsers = new LDLinkedList<>();
